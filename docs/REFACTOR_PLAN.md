...
## التاسكات المؤجلة (Deferred Tasks)

### D1 — Sort/Filter في صفحة الحجوزات
في `_openWalletAllocationSheet` — لما اليوزر يفتح محفظة جوه كارت الحصالة،
يظهر تحت كارت المحفظة فلتر:
- تصاعدي / تنازلي (بالقيمة)
- فلتر بالوقت (آخر أسبوع / آخر شهر / كل الوقت)

### D2 — فتح معاملات الحجز من صفحة المحافظ
لما اليوزر يفتح كارت المحفظة (من صفحة المحافظ، مش الحصالة) ويدوس على
"مكان الفلوس"، يظهر الحصالات المرتبطة — لما يدوس على أي حصالة يجيبله
معاملات الحجز بتاعتها بنفس UX بتاع `_openWalletAllocationSheet`.
